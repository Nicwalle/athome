...
class ProgressSteps extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1 }}>
                {this.props.stepIconsLocation==='top' ? <View style={styles.stepIcons}>{this.renderStepIcons()}</View> : <></>}
                <View style={{ flex: 1 }}>
                ...
                {this.props.stepIconsLocation==='bottom' ? <View style={styles.stepIcons}>{this.renderStepIcons()}</View> : <></>}
            </View>
        );
    }
}
...
ProgressSteps.propTypes = {
    ...
    stepIconsLocation: PropTypes.oneOf(['top', 'bottom', 'hidden'])
};
